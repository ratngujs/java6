        ...
        <nav class="navbar position-relative navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                <div class="navbar-nav mr-auto py-0">
                    ...
                    <a href="/admin/thongke/top10" class="nav-item nav-link active">Thống Kê</a>
 ...
 <a href="/login" class="nav-item nav-link">Đăng Nhập/Đăng Ký</a>
	...
	<c:if test="${not empty start}">
		<script>
			...
			let end = "${end}";
			$(document).ready(function(){
		 		$('#reservation').data('daterangepicker').setStartDate(moment(start).format('DD/MM/YYYY'));
		 		$('#reservation').data('daterangepicker').setEndDate(moment(end).format('DD/MM/YYYY'));
			});
		</script>
	</c:if>

	<form action="/admin/thongke/top10range" method="POST">
