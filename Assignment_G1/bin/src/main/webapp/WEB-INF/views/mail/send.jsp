            ...
            <div class="col-12 col-sm-8 mb-5">
                <div class="contact-form">
					...
					<fr:form method="POST" enctype="multipart/form-data"
                        ...
                        <fr:input type="text" class="form-control p-4"  path="to" placeholder="Nhập email của bạn" required="required" data-validation-required-message="Please enter your Email"/>
                           
                            <p class="help-block text-danger"></p>
                        </div>
                       
                        <div class="control-group">
                        <fr:input path="subject" type="text" class="form-control p-4"  placeholder="Tên vấn đề" required="required" data-validation-required-message="Please enter a subject"/>
                           
                            <p class="help-block text-danger"></p>
                        </div>
                        <div class="control-group">
                        	<fr:textarea class="form-control p-4" rows="6"  placeholder="Mô tả vấn đề" required="required" data-validation-required-message="Please enter your message" path="body"/>
                           
                            <p class="help-block text-danger"></p>
                        </div>
                        <div>
                        	<input type="file" name="attachment" multiple="multiple" />
						<fr:button name="btnGui" class="btn btn-primary py-3 px-5" type="submit" >Gửi Ngay</fr:button>
