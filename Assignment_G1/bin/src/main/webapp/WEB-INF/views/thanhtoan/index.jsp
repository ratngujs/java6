...
<body>
 ...
 <a href="/login" class="nav-item nav-link">Đăng Nhập/Đăng Ký</a>
	...
	<div class="well well-small">
		<h1>
					Thông tin thanh toán <small class="pull-right">Có ${cart.items.size()}
		...
		<br />
			...
			<form class="col-md-4 col-md-offset-4">
				Địa chỉ: <input type="text" name="diachi" /> <br/> <br> <a
					href="/cart/view" class="shopBtn btn btn-primary border-2"><span
					class="icon-arrow-left"></span> Quay lại giỏ hàng </a>
				<button formaction="/thanhtoan" formmethod="POST" type="submit"
					class="shopBtn btn btn-info border-2">
