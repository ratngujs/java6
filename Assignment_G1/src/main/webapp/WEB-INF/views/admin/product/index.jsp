...
<script type="text/javascript">
	function deleteSP(id){
		if(confirm("Bạn muốn xóa sản phẩm đúng không?") == true){
	        ...
	        "columns": [
	            ...
	            { 
	            	...
	            	"render": function ( data, type, row ) {
                    	return "<a href='/admin/product/edit/"+data+"' class='btn btn-warning'>Edit</a> "+
                    			"<a href='javascript:deleteSP("+data+")' class='btn btn-danger'>Delete</a>";
                	},
	            	"sortable": false
	            }
	        ],
...
<!-- Topbar Start -->
        ...
        <nav class="navbar position-relative navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                <div class="navbar-nav mr-auto py-0">
                    ...
                    <a href="/admin/product" class="nav-item nav-link active" >Sản Phẩm</a>
 ...
 <a href="/login" class="nav-item nav-link">Đăng Nhập/Đăng Ký</a>
	...
	<h1 align='center'>DANH SÁCH SẢN PHẨM</h1>
	 ...
	 <table class="table table-hover table-striped" border="2" style="width: 100%">
		...
		<c:forEach var="item" items="${pageProduct.content}">
			<tr>
				...
				<td><div class="text-center"><a class="btn  btn-primary  border-2 btn-lg" href="/admin/product/edit/${item.id}">Edit</a></div></td>
				<td><div class="text-center"><a class="btn  btn-danger border-2 btn-lg"href="/admin/product/delete/${item.id}">Delete</a></div></td>
			</tr>
		</c:forEach>
	</table>
	<div class="row">
		<div class="column">
			<ul>
				<li>Trang số: ${pageProduct.number + 1}</li>
				<li>Kích thước trang: ${pageProduct.size}</li>
				<li>Tổng số trang: ${pageProduct.totalPages}</li>
				<li>Số phần tử hiện tại: ${pageProduct.numberOfElements}</li>
				<li>Tổng số phần tử: ${pageProduct.totalElements}</li>
			</ul> -
		</div>
		<div class="column" style="text-align: right;">
			<a class='btn btn-primary border-2' href="/admin/product?page=0"> |&lt; </a> 
			<a class='btn btn-primary border-2'	href="/admin/product?page=${pageProduct.number-1 < 0 ? pageProduct.totalPages -1:pageProduct.number-1}">&lt;&lt; </a>
			<a class='btn btn-primary border-2' href="/admin/product?page=${pageProduct.number+1 > pageProduct.totalPages -1?0: pageProduct.number+1}">&gt; &gt; </a>
			<a class='btn btn-primary border-2'	href="/admin/product?page=${pageProduct.totalPages-1}"> &gt;| </a>
		</div>
	</div> 
	 <!-- Footer Start -->
