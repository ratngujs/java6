 ...
 <!-- Topbar Start -->
                ...
                <div class="navbar-nav mr-auto py-0">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu rounded-0 m-0">
                            ...
                            <a href="/login" class="dropdown-item">Sign up and Login</a>
                        </div>
                    </div>
                    <a href="/contact" class="nav-item nav-link active">Contact</a>
                </div>
                <a href="" class="btn btn-lg btn-primary px-3 d-none d-lg-block">Báo Giá</a>
            </div>
        </nav>
    </div>
    <!-- Navbar End -->
    ...
    <div class="container-fluid pt-5">
        <div class="d-flex flex-column text-center mb-5 pt-5">
            <h4 class="text-secondary mb-3">Liên Hệ Với Chúng Tôi</h4>
            <h1 class="display-4 m-0">Liên hệ ngay <span class="text-primary">Vấn đề bạn đang gặp</span></h1>
        </div>
            ...
            <div class="col-12 col-sm-8 mb-5">
                <div class="contact-form">
                    ...
                    <fr:form method="POST" enctype="multipart/form-data"
						modelAttribute="mailModel" action="" name="sentMessage" id="contactForm" novalidate="novalidate">
                  
                        <div class="control-group">
                        <fr:input type="text" class="form-control p-4" id="name" path="to" placeholder="Nhập email của bạn" required="required" data-validation-required-message="Please enter your Email"/>
                           
                            <p class="help-block text-danger"></p>
                        </div>
                       
                        <div class="control-group">
                        <fr:input path="subject" type="text" class="form-control p-4" id="subject" placeholder="Tên vấn đề" required="required" data-validation-required-message="Please enter a subject"/>
                           
                            <p class="help-block text-danger"></p>
                        </div>
                        <div class="control-group">
                        	<fr:textarea class="form-control p-4" rows="6" id="message" placeholder="Mô tả vấn đề" required="required" data-validation-required-message="Please enter your message" path="body"/>
                           
                            <p class="help-block text-danger"></p>
                        </div>
                        <div>
                        	<input type="file" name="attachment" multiple="multiple" />
						<fr:button name="btnGui" class="btn btn-primary py-3 px-5" type="submit" id="sendMessageButton">Gửi Ngay</fr:button>
